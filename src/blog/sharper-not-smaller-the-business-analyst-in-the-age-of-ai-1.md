---
title: "What to Hand to AI (The Safe List)"
series: "Sharper, Not Smaller: The Business Analyst in the Age of AI"
day: 2
description: "Yesterday I drew one line: artefact versus accountability. Today I want to make it practical, starting with the side you can give away. Most analysts are…"
date: 2026-06-16T12:40:12.610Z
cover: "/images/blog/f4dc16_3f539f805aa74feb974a89ed7da14ef5.png"
readingTime: 5
wixId: "1d6b6c5f-4700-46a3-acf2-29c8bf0e26ab"
---
<img src="/images/blog/f4dc16_3f539f805aa74feb974a89ed7da14ef5.png" alt="What to Hand to AI (The Safe List)" width="2848" height="1472" loading="lazy">
...
## Why handing this over is not lazy

Some analysts feel a flicker of guilt about this as though good work has to be slow and done entirely by hand to count. Let that go. Nobody admires a carpenter for refusing to use a power drill. The skill was never in the turning of the screw. It was in knowing what to build and whether the result is sound. The same is true here. The value was never in you personally typing the first draft of a requirements section. The value is in the requirements being right, complete, and defensible. The drill does not make the carpenter less skilled. It makes them faster at the part that was never the point.

When I moved this work off my plate, two things happened. My week opened up, and the quality of my real work went up, because I had more attention left for the parts that needed it. Let me give you a real number from my own week. I used to set aside the better part of a day to turn a long discovery session into clean, structured notes. Recording, replaying, typing, tidying. Now a tool gives me a first-pass summary in minutes, and I spend perhaps forty minutes correcting it, adding the context it missed, and flagging the moments that need a follow-up. The notes are better than they used to be, because I am reading for meaning instead of straining to transcribe. The hours I saved did not vanish. They went into the conversations that actually needed me.

## The one trap to avoid

There is a catch, and it is the same one that embarrassed the junior analyst from yesterday. Handing over the production of an artefact is safe. Handing over the judgment inside it is not. Every item on this list produces a draft, not a decision. You read it, you correct it, you own the result. The safe list is not a list of things you stop caring about. It is a list of things you stop typing from scratch. You still own every word that goes out under your name. You are just no longer doing the slow, mechanical first 90% by hand.

A simple habit makes this safe. Never send AI output onward without reading every line as if you wrote it, because as far as the room is concerned, you did. If you cannot defend a sentence, cut it or rewrite it until you can. This is also where a quiet professional standard separates strong analysts from careless ones. The careless analyst treats the draft as the finish line. The strong one treats it as the start line. Same tool, completely different outcome, and the difference is entirely in the human who picks the draft up.
