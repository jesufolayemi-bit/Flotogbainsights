---
title: "How the way you state a problem controls the answers you can see"
series: "Critical Thinking: How to Be Right More Often"
day: 2
description: "The frame you put around a problem decides, before anyone says a word about solutions, which solutions are even thinkable. This is the most powerful idea in…"
date: 2026-07-07T14:23:16.948Z
cover: "/images/blog/f4dc16_ae03bc5baae64eb4aba6b23c7eaee7a0.png"
readingTime: 6
wixId: "609b5b43-625b-49e9-b0db-3993b8cc0023"
---
...
## The slow elevator and what it teaches

The story in today's post is a real and much-loved example, popularised by Thomas Wedell-Wedellsborg in his work on problem framing. Tenants complain that the elevators are too slow. Framed that way, as an elevator-speed problem, the solutions are all about the elevators: faster motors, better algorithms, another lift, all costly and disruptive. But someone reframed it. The real problem, they suggested, is not that the wait is long, but that the wait is unpleasant and boring. Framed as a boredom problem, an entirely different and far cheaper set of solutions opens up, and the winning one was mirrors, which give people something to do while they wait. The complaints stopped. Nothing about the elevators changed at all.

The lesson is not that mirrors fix elevators. It is that the frame did all the work. Two honest, accurate descriptions of the same situation, slow elevators and a boring wait, led to two completely different worlds of solutions, one expensive and one nearly free. Neither description was wrong. But one was far more useful, and the only way to find it was to treat the first frame as a choice rather than a fact, and to deliberately try another.

## Why does the frame have this power

Kahneman and Tversky showed that the same facts, described two ways, lead people to different decisions. A treatment described as having a ninety per cent survival rate is chosen far more often than the same treatment described as having a ten per cent death rate, though the numbers are identical. This is the framing effect, and it runs deeper than a trick of language. The frame decides what your attention lands on, what feels relevant, and what you quietly ignore. A problem framed around cost makes you think about money. The same problem framed around risk makes you think about what could go wrong. The frame is a spotlight, and everything outside its beam stays dark, no matter how important it is.

## Frame around what people want, not what they lack
...
Reframing is a skill you can practise, not a flash of genius that either strikes or does not. When a problem feels stuck, or the only solutions on offer are all expensive and joyless, that is the signal to step back and work the frame itself.

- State the current frame out loud, in one sentence, so you can actually see the boundary you have drawn.
- Name the frame's hidden assumption. "The elevators are too slow" assumes the problem is speed. Say the assumption, then question it.
- Go one level up to what is really wanted. Not a faster lift but a pleasant building. Not a report but a decision made on time.
- Write the problem two or three other ways, around a different actor, outcome or cause, and see which frame opens the cheapest good answers.
- Try the opposite. If the frame is how do we get people to use this, flip it to why would anyone not use this, which often surfaces the real obstacle.
- Ask who sees this completely differently. The person from another team, or the newcomer with no history, often holds the frame you cannot see from inside your own.

## The mistakes that trap you in one frame

Most framing failures come from never realising a frame was chosen at all.

1. Accepting the first framing because it sounds obvious, and never noticing that obvious is not the same as best.
2. Stating the problem in the language of your own function, so every problem becomes the kind you happen to solve for a living.
3. Confusing a narrow frame with a focused one. Narrowing too early feels disciplined but can cut off the reframe that would have solved the whole thing cheaply.
4. Treating reframing as wordplay. Changing the words without changing where you look is relabelling, and it moves nothing.

## You will feel this in your next planning meeting
