---
title: "Why capable, experienced people get confidently wrong"
series: "Critical Thinking: How to Be Right More Often"
day: 1
description: "You cannot think your way out of a bias you do not believe you have. That is what makes bias the hardest problem in this whole series, and the right place to…"
date: 2026-07-06T12:55:50.321Z
cover: "/images/blog/f4dc16_7fe0588dee6048008d38370a92eeae11.png"
readingTime: 6
wixId: "584b94ab-bc3f-41cb-a4f9-32aaab1fd9a0"
---
...
It is worth sitting with how invisible these are from the inside. I once watched a planning session where the first person to speak floated a rough guess of two weeks for a piece of work nobody had scoped yet. For the next hour, every estimate offered landed somewhere between ten days and three weeks. When the work was finally broken down properly, it was closer to two months. Nobody in that room felt anchored. They felt like they were reasoning. The two-week guess had simply become the gravity the whole conversation fell toward, and the only thing that would have broken its pull was someone noticing it was there and saying so out loud before the numbers started.

It would be comforting to think these biases fade with experience. They do not, and there is a specific reason. Expertise is built on pattern recognition, on having seen enough that the answer arrives before you have consciously worked it out. That is genuinely valuable, and it is also exactly the machinery that produces confident error. The expert's fast system offers an answer so quickly and so fluently that the slow system sees no reason to check it. A newcomer, unsure, is sometimes forced into the slow, careful thinking that the expert has learned to skip. This is why the phrase to fear most in your own head is "it is obvious". Obvious is the feeling of the fast system refusing to be checked.

## Why trying harder does not work

The natural response, once you accept you are biased, is to resolve to be more objective, to try harder to see straight. It does not work, and understanding why saves years of wasted effort. Bias is not a lapse in concentration. It is the normal operation of a fast, efficient mind, and you cannot out-concentrate it any more than you can out-concentrate an optical illusion. Staring harder at the two lines does not stop the one that looks longer from looking longer. What changes the answer is not effort but a different process: a ruler laid against the lines, a step that checks the intuition from the outside. The same is true in your work. You do not beat your biases by being determined to be fair. You beat them by building small habits that check your thinking, whether or not you feel biased at the time, because the whole trouble is that you never feel biased at the time.
...
The failures here are quiet, because they feel like competence while they happen.

- Believing bias is other people's problem. The moment you feel immune is the moment you are least protected, because you have stopped watching yourself.
- Treating confidence as a signal of accuracy. How sure you feel and how right you are are only loosely related, and experience widens the gap.
- Gathering evidence only after you have already decided, then calling the pile of it proof.
- Letting the loudest or earliest voice set the anchor, and mistaking the resulting agreement for a conclusion the group actually reasoned its way to.
